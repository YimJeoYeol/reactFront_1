...
function BbsDetail() {
    ...
    const getBbsDetail = async () => {
        try {
            const response = await axios.get(`http://localhost:8686/board/${boardId}`);
    ...
    const deleteBbs = async () => {
        try {
            const response = await axios.delete(`http://localhost:8686/board/${boardId}/delete`, {headers: headers});
